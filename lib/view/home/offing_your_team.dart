...
class OffingYourTeam extends StatefulWidget {
  final String matchId, teamId;
  const OffingYourTeam(this.matchId, this.teamId, {Key? key}) : super(key: key);

  @override
  State<OffingYourTeam> createState() => _OffingYourTeamState();
}

class _OffingYourTeamState extends State<OffingYourTeam> {
