...
import 'package:elevens_organizer/view/my_matches/profile.dart';
...
class PlayerListCard extends StatelessWidget {
  final String playerName, style, playerImage, id, teamId, role, playerId;
  final bool showChangeRoleOption;
  final MatchTeamPlayerList player;
  const PlayerListCard(this.playerName, this.style, this.playerImage, this.showChangeRoleOption, this.id, this.teamId, this.role, this.player, this.playerId, {Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Bounceable(
      onTap: (){
        Navigator.push(context, ScaleRoute(page:  PlayerProfile(playerId.toString())));
      },
      child: Row(
        children: [
